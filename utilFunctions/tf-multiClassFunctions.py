...
#ASSUMPTIONS
#labels are in order starting from 0 to numOfLabels - 1
...
#function to correct the dataset: assign parent label class to all the child labels (e.g. child speech should also have speech)
#The parent child class have to be manually put in from the ontology for all the classes I select in the new label format
